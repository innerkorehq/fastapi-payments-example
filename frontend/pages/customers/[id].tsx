...
import { customerApi, paymentMethodApi } from '../../lib/payment-api';
...
export default function CustomerDetail() {
  ...
  useEffect(() => {
    const fetchCustomerData = async () => {
      ...
      try {
        ...
        const mockCustomer = {
          id: customerId,
          email: `customer_${customerId.substring(0, 5)}@example.com`,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>{customer.name || customer.email} | Customer Details</title>
      </Head>
